...
class Bird():
    ...
    def get_inputs(self, pipes):
        ...
        inputs = [
            ((horizontal_distance / NORMALIZER)*0.99) + 0.01,
...
class BirdCollection():
    ...
    def evolve_population(self):
        ...
        num_bad_to_keep = int(len(bad_birds) * MUTATION_BAD_TO_KEEP)
        ...
        idx_bad_to_take = np.random.choice(np.arange(len(bad_birds)), num_bad_to_keep, replace=False)
